...
export default function ThemeSwitchToggle() {
  ...
  const [currentTheme, setCurrentTheme] = React.useState(localStorage.getItem("data-theme"));
  ...
  return <div className='px-3 py-3' onClick={toggleOn} >{currentTheme === 'dark' ? <IconDark height={20} /> : <IconLight height={20}/>}</div>
}
