...
export function toMultisigRune(setup: Setup): MultisigRune<SupportedChain, never> {
...
export function toMultiAddressIdRune(address: string): ValueRune<MultiAddress.Id, never> {
